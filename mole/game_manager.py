...
class GameManager:
    ...
    def start_game(self, sio, sid, token, start_position=None, test_choices=None, all_proofs=False):
        ...
        game = Game(sio, pending_game.token, pending_game.host_sid, pending_game.players, start_position, test_choices, all_proofs)
